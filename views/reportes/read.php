    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="box box-widget">
                      <div class="box-header with-border">
                        <div class="user-block">
                          ...
                          <span class="description">&nbsp; Reporte de la bitácora por sucursal</span>
                        </div>              
                        <div class="box-tools">
                      ...
                      <div class="box-body">              
                        ...
                        <div class="form-group">
                          ...
                          <select id="tipo_calibracion" name="tipo_calibracion" class="form-control select2" multiple="multiple" data-placeholder="Seleccionar tipo de calibración" style="width: 100%;">                                     
                            <?php
                              foreach ($data['tipocalibracion'] as $tipocal) {                                                     
                        ...
                        <div class="form-group">
                          ...
                          <select id="proceso" name="proceso" class="form-control select2" multiple="multiple" data-placeholder="Seleccionar tipo de calibración" style="width: 100%;">
                          ...
                          <button type="button" id="allproceso" class="btn btn-default pull-left"><i class="fa fa-ellipsis-v" aria-hidden="true"></i> &nbsp; Seleccionar todos</button>
                          <button type="button" id="cleanproceso" class="btn btn-default pull-left"><i class="fa fa-refresh" aria-hidden="true"></i> &nbsp;Limpiar</button>            
                        </div>                           
                      </div>              
                      ...
                      <div class="box box-widget">
                        <div class="box-header with-border">
                          <div class="user-block">                           
                            ...
                            <span class="description">Informes en Bitácora</span>
                          </div>
                          <!-- /.user-block -->
                          <div class="box-tools" >
                            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
        ...
        <script type="text/javascript">
          ...
          var config = {
            type: 'line',
            data: {
              labels: ['Inicio', 'Calibración', 'Salida', 'Facturación', 'Terminado'],
              datasets: [{
                label: 'Total',
            ...
            options: {
              ...
              scales: {
                xAxes: [{
                  ...
                  scaleLabel: {
                    display: true,
                    labelString: 'Procesos en bitácora'
                  }
                }]
              }            
            }
          ...
          $(document).ready(function(){
            ...
            $("#allproceso").on('click', allproceso);
            $("#cleanproceso").on('click', cleanproceso);           
              ...
              //Array de los campos capturados                      
                ...
                if(validacion == true){
                  ...
                  $.ajax({
                    ...
                    for (var i in obj) {                   
                      bitacoraData.push(obj[i]['proceso']);                                        
                    }
                    ...
                    for(var i in labels){                        
                        //bitacoraData.push(obj[i]['proceso']);
                        for(var j in bitacoraData){                                                 
                          if(labels[i] == bitacoraData[j]){                         
                            count++;
                          }
                        }                       
                        bitacoraData.splice(0, count);                        
                        dataset.push(count);
                        count=0;                                                                                                                                                     
                    }                     
                    // console.log();
