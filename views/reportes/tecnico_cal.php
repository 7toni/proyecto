          ...
          <div class="box box-widget">
            ...
            <div class="box-body">              
              ...
              <div class="form-group">
                ...
                <select id="tecnico" class="form-control select2" data-placeholder="Seleccionar técnico"
                        style="width: 100%;" name="tecnico">                      
                  <option value="todos" selected="selected">Todos</option>
                  <?php
                    foreach ($data['tecnico'] as $tecnico) {                          
                        echo '<option value="'.$tecnico['email'].'">'.$tecnico['email'].'</option>';                                                                          
                    }
                  ?>     
                </select>
              </div>                 
        ...
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
          <!-- Box Comment -->
            <div class="box box-widget">
              ...
              <!-- /.box-header -->
              <div class="box-body">
                <canvas id="myChart" style="width:100%; height:auto;" width="150" height="68%"></canvas>
              </div>
              <!-- /.box-body -->            
            </div>
          <!-- /.box -->
