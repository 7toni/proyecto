...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Control de Bajas Dep. Prueba Eléctrica</h3>
        ...
        <script>
           var controller = "<?php echo $this->name .'  '.'bajas '; ?>";            
                ...
                "columnDefs": [
                    {
                        ...
                        "render": function(data,type, row){                                                                   
                            menu = "<a href='?c=control_pruebaelect&a=enable&p=" + data[0]+"' data-type='enable' class='btn btn-social-icon badge bg-green' title='Activar Equipo'><i class='fa fa-toggle-on'></i></a>";
                            menu += "<a href='?c=control_pruebaelect&a=delete&p=" + data[0]+"' data-type='delete' class='btn btn-social-icon badge bg-red' title='Eliminar'><i class='fa fa-trash-o'></i></a>";
