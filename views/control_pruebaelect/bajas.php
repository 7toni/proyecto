                ...
                "columnDefs": [
                    {
                        ...
                        "render": function(data,type, row){                                                                   
                            menu = "<a href='?c=control_pruebaelect&a=enable&p=" + row[0]+"' data-type='enable' class='btn btn-social-icon badge bg-green' title='Activar Equipo'><i class='fa fa-toggle-on'></i></a>";
