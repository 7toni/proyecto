                                    ...
                                    <form method="POST" autocomplete="off"  action="?c=<?php echo $this->name; ?>&a=store" role="form">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                &nbsp; Requiere Calibración / Comprobación Metrológica
                                                </label>                                                                                                
                                            </div> 
                                            <div class="form-group">
                                                <label>
                                            ...
                                            <div id="grupo_informes">
                                                ...
                                                <div class="form-group">
                                                    <label >Estado de Calibración / Comprobación</label>                                  
                                                    <select class="form-control select2" style="width: 100%;" id="estadoc" name="estadoc">
                                                        <option value="1">Calibrado / Comprobado</option>                                                         
                                                        <option value="0">No Calibrado / Comprobado</option>
                                                    </select>
                                                </div>
                                            </div>                                                                                                                                  
                                        </div>
                                        <div class="box-footer"><button type="submit" class="btn btn-primary btn-flat">Guardar</button> <button type="button" class="btn btn-danger btn-flat pull-right" onClick="history.back()">Cancelar</button></div>
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            ...
            var buscar_informe = function() {
                if (validar_text($("#informe").val().trim()) == true) {
                    $.ajax({
                        url: "?c=control_calidadpe&a=ajax_load_informe",
                        dataType: "json",
                        method: "POST",
