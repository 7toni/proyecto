                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header  with-border">
                                    <h3 class="box-title">Cancelar Equipo </h3>
                                </div>
                                <div class="box-body">
                                    ...
                                    <?php } ?>
                                    <form method="POST" autocomplete="off"  action="?c=<?php echo $this->name;?>&a=disabled" role="form">
                                        ...
                                        <div class="box-body">                                            
                                            ...
                                            <div class="form-group">
                                                <h4>Observaciones</h4>
                                                <textarea class="form-control" rows="4" id="comentario" name="comentario" placeholder="Observaciones ..." require=''></textarea>
                                            </div>                                                                                          
                                            <!-- Fecha de Mantenimiento -->
                                            <div class="form-group">
                                                <h4 for="fecha_mantenimiento">Fecha de baja</h4>
                                        ...
                                        <div class="box-footer">
                                            <button type="submit" class="btn btn-danger btn-flat">Baja</button>
        ...
        <script>
            var buscar_idequipo = function() {
                if (validar_text($("#idequipom").val().trim()) == true) {
                    $.ajax({
                        url: "?c=historialcm&a=ajax_load_equipo",
                        dataType: "json",
                        method: "POST",
