                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table id="table_historialm" class="table table-bordered table-striped table-hover" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Id Equipo</th>
                                                ...
                                                <th style="width:90px">Tipo de Mant.</th>
                                                <th style="width:95px">Fecha de Mant.</th>
