                                    ...
                                    <form method="POST" autocomplete="off"  action="?c=<?php echo $this->name;?>&a=destroy" role="form">
                                        ...
                                        <div class="box-body">                                            
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="procedimiento" name="procedimiento" disabled/>                                                                                          
                                            </div>
                                             <!-- Campo de aplicación  -->                                            
                                             <div class="form-group">
                                                <h4 for="campo_aplicacion">Campo de aplicación *</h4>
                                                <input type="text" class="form-control" id="campo_aplicacion" name="campo_aplicacion" disabled/>                                                                                          
                                            </div>
                                            <!-- Localización -->                                            
                                            <div class="form-group">
                                                <h4 for="localizacion">Localización *</h4>
                                                <input type="text" class="form-control" id="localizacion" name="localizacion" disabled/>                                                                                          
                                            </div>
                                             <!-- Observaciones -->
                                            <div class="form-group">
                                                <h4>Observaciones</h4>
                                                <textarea class="form-control" rows="4" id="comentario" name="comentario" placeholder="Observaciones ..." disabled></textarea>
                                            </div>                                            
                                            <!-- /.form group -->
                                        </div>
