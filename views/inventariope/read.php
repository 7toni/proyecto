    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <table id="table_inventarioc" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>id</th>
                                                <th>Clave</th>                                                
        ...
        <script>
            ...
            $(document).ready(function(){
                $('#table_inventarioc thead tr').clone(true).appendTo( '#table_inventarioc thead' );
                $('#table_inventarioc thead tr:eq(1) th').each( function () {
                    var title = $(this).text();
                ...
                var table_inventarioc = $('#table_inventarioc').DataTable({
                    ...
                    "columns": [
                        ...
                        { "data":  8}, // "procedimiento"
                        { "data":  9}, //"campo_aplicacion"
                        { "data":  10}, // "localizacion"
                        { "data":  11 }, // "responsable"
                        { "data": 12 }, // "comentario"
                ...
                table_inventarioc.columns().every( function () {
                    var that = this;
                ...
                $('#table_inventarioc tbody').on('click', 'td.details-control', function () {
                        var tr = $(this).closest('tr');
                        var row = table_inventarioc.row( tr );
