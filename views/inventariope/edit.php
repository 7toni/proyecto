                                    ...
                                    <input type="hidden" id="id" name="id" value="<?php echo $data['get'][0]['id']; ?>">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="procedimiento" name="procedimiento" requiere="" value="<?php echo $data['get'][0]['procedimiento']; ?>"/>                                                                                          
                                            </div>
                                             <!-- Campo de aplicación  -->                                            
                                             <div class="form-group">
                                                <h4 for="campo_aplicacion">Campo de aplicación *</h4>
                                                <input type="text" class="form-control" id="campo_aplicacion" name="campo_aplicacion" requiere="" value="<?php echo $data['get'][0]['campo_aplicacion']; ?>"/>                                                                                          
                                            </div>
                                            <!-- Localización -->                                            
                                            <div class="form-group">
                                                <h4 for="localizacion">Localización *</h4>
                                                <input type="text" class="form-control" id="localizacion" name="localizacion" requiere="" value="<?php echo $data['get'][0]['localizacion']; ?>"/>                                                                                          
                                            </div>
                                             <!-- Observaciones -->
                                            <div class="form-group">
                                                <h4>Observaciones</h4>
                                                <textarea class="form-control" rows="4" id="comentario" name="comentario" placeholder="Observaciones ..."><?php echo $data['get'][0]['comentario']; ?></textarea>
                                            </div>                                            
                                            <!-- /.form group -->
                                        </div>
