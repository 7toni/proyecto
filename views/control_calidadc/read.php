...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Control de <?php echo $this->title; ?> Dep. Calibración</h3>
                                    <a href="?c=<?php echo $this->name; ?>&a=add" class="btn btn-primary btn-md pull-right btn-flat">Agregar nuevo</a>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="tablecc" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>id</th>                                                
                                                <th>Clave</th>
        ...
        $(document).ready(function(){
            ...
            $('#tablecc thead tr').clone(true).appendTo( '#tablecc thead' );
                $('#tablecc thead tr:eq(1) th').each( function () {
                var title = $(this).text();
            ...
            var tablecc = $('#tablecc').DataTable({
                ...
                "columnDefs": [
                    ...
                    },
                    {
                        ...
                        "data": null,                    
                        "render": function(data,type, row){
                            var menu="<a href='?c=control_calidadc&a=edit&p=" + row[0]+"' data-type='edit' class='btn btn-social-icon badge bg-yellow' title='Editar'><i class='fa fa-edit'></i></a>";                    
                            if(row[16]==1){
                                menu += "<a href='?c=historialcm&a=add&p="+ row[1] +"' data-type='addm' target='_blank' class='btn btn-social-icon badge bg-blue' title='Actualizar Mantenimiento'><i class='fa fa-cogs'></i></a>";                            
                            }                        
                            if(row[21]==1){
                                menu +="<a href='?c=historialcv&a=add&p="+ row[1] +"' data-type='addv' target='_blank' class='btn btn-social-icon badge bg-gray' title=' Actualizar Verificación'><i class='fa fa-eye'></i></a>";                            
                            }                                             
                            menu += "<a href='?c=control_calidadc&a=cancel&p=" + row[0]+"' data-type='cancel' class='btn btn-social-icon badge bg-black' title='Baja de equipo'><i class='fa fa-power-off'></i></a>";
                            menu += "<a href='?c=inventarioc&a=add&p="+ row[1] +"' data-type='addi' class='btn btn-social-icon badge bg-teal' title='Agregar a inventario'><i class='fa fa-database'></i></a>";
            ...
            tablecc.columns().every( function () {
                var that = this;
            ...
            $('#tablecc tbody').on('click', 'td.details-control', function () {
                var tr = $(this).closest('tr');
                var row = tablecc.row( tr );
