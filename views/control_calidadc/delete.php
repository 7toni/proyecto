                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <form method="POST" autocomplete="off"  action="?c=<?php echo $this->name; ?>&a=destroy" role="form">
                                        ...
                                        <div class="box-footer"><button type="submit" class="btn btn-danger btn-flat">Eliminar</button><button type="button" class="btn btn-danger btn-flat pull-right" onClick="history.back()">Cancelar</button></div>
                                    </form>
                                </div>
                            </div>
                        </div>
